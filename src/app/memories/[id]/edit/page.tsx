                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex bg-neutral-50 dark:bg-neutral-900 p-0.5 rounded-lg border border-neutral-100 dark:border-neutral-800">
                        ...
                        <button
                          ...
                          className={`text-[9px] uppercase font-mono font-bold tracking-wider px-2 py-1 rounded-md transition-all cursor-pointer outline-none ${
                            isPreview ? "bg-white dark:bg-neutral-850 shadow-sm text-neutral-950 dark:text-white" : "text-neutral-405 hover:text-neutral-605"
                          }`}
                        >
                          Preview
                        </button>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="h-10 bg-neutral-50/50 dark:bg-neutral-900/40 border-neutral-100 dark:border-neutral-900 rounded-xl text-xs placeholder:text-neutral-450 focus-visible:ring-0 focus-visible:border-neutral-200 dark:focus-visible:border-neutral-800 shadow-none text-neutral-800 dark:text-neutral-200"
                      />
